...
public class AdachireiNuiBlockEntityRenderer implements BlockEntityRenderer<AdachireiNuiBlockEntity> {
    ...
    public static final Identifier MODEL_ADACHI_NUI = new Identifier(AdachireiNui.CONTENT_NAMESPACE, "models/block/adachi-nui.json");
    public static final Identifier MODEL_ADACHI_NUI_NEW = new Identifier(AdachireiNui.CONTENT_NAMESPACE, "models/block/adachi-nui_new.json");
    public static final Identifier MODEL_ADACHI_NUI_VOCALOID = new Identifier(AdachireiNui.CONTENT_NAMESPACE, "models/block/adachi-nui_vocaloid.json");
    ...
    @Override
    public void render(AdachireiNuiBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        renderParsedModel(modelId, state.get(AdachireiNuiBlock.FACING), matrices, vertexConsumers, light, overlay);
    }

    public static void renderParsedModel(Identifier modelId, Direction facing, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
    ...
    private static void vertex(VertexConsumer consumer, Matrix4f position, MatrixStack.Entry entry, Vector3f vertex, float u, float v, int light, int overlay, Vector3f normal) {
